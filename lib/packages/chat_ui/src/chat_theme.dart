...
class DefaultChatTheme extends ChatTheme {
  ...
  const DefaultChatTheme({
    ...
    List<Color> userAvatarNameColors = chatAvatarColors,
    ...
    TextStyle userNameTextStyle = const TextStyle(
      ...
      height: 1.333,
          ...
          attachmentButtonIcon: attachmentButtonIcon ?? const SizedBox(),
          backgroundColor: backgroundColor,
          dateDividerTextStyle: dateDividerTextStyle,
          deliveredIcon: deliveredIcon ?? const SizedBox(),
          documentIcon: documentIcon ?? const SizedBox(),
          emptyChatPlaceholderTextStyle: emptyChatPlaceholderTextStyle,
          errorColor: errorColor,
          errorIcon: errorIcon ?? const SizedBox(),
          ...
          sendButtonIcon: sendButtonIcon ?? const SizedBox(),
          sendingIcon: sendingIcon ?? const SizedBox(),

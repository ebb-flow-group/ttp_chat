...
/// Should use Navigator.of(context).pop() to pop.
/// Because this route not added to pages in NavigationStore.
Future<void> showOkDialog(
    BuildContext context, String title, String text) async {
  showCupertinoDialog(
    context: context,
    builder: (BuildContext context) => CupertinoAlertDialog(
      title: Text(title, style: Ts.bold20(Colors.black)),
      content: Text(text, style: Ts.text16(Colors.black)),
      actions: [
        CupertinoDialogAction(
          child: Text('Ok', style: Ts.text18(Colors.blueAccent)),

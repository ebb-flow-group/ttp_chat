...
String brandFirebaseTokenModelToJson(BrandFirebaseTokenModel data) =>
...
class BrandFirebaseTokenModel {
  ...
  factory BrandFirebaseTokenModel.fromJson(Map<String, dynamic> json) =>
      BrandFirebaseTokenModel(
        brandFirebaseTokenList: json["brand_firebase_tokens"] == null
            ? []
            : List<BrandFirebaseTokenData>.from(json["brand_firebase_tokens"]
                .map((x) => BrandFirebaseTokenData.fromJson(x))),
      );
...
String brandFirebaseTokenDataToJson(BrandFirebaseTokenData data) =>
    json.encode(data.toJson());
...
class BrandFirebaseTokenData {
  ...
  factory BrandFirebaseTokenData.fromJson(Map<String, dynamic> json) =>
      BrandFirebaseTokenData(
